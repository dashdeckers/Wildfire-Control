...
//        agents.add(new Agent(width/4,height/4,model, parameter_manager,3));
//        agents.add(new Agent(width/2 ,0, model, parameter_manager,4));
//        agents.add(new Agent(width*3/4,height/4,model, parameter_manager,5));
//        agents.add(new Agent(width-1 ,height/2,model, parameter_manager,6));
//        agents.add(new Agent(width*3/4,height*3/4,model, parameter_manager,7));
//        agents.add(new Agent(width/2 ,height-1, model, parameter_manager,0));
//        agents.add(new Agent(width/4,height*3/4,model, parameter_manager,1));

        ///////// : LINE
//        agents.add(new Agent(0 ,height/2,model, parameter_manager,0));
//        agents.add(new Agent(1 ,height/2,model, parameter_manager,1));
//        agents.add(new Agent(2 ,height/2,model, parameter_manager,2));
//        agents.add(new Agent(3 ,height/2,model, parameter_manager,3));
//        agents.add(new Agent(4 ,height/2,model, parameter_manager,4));
//        agents.add(new Agent(5 ,height/2,model, parameter_manager,5));
//        agents.add(new Agent(6 ,height/2,model, parameter_manager,6));
